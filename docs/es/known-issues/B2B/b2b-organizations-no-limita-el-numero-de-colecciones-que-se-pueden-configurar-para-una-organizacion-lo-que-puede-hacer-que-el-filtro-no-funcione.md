---
title: 'B2B Organizations no limita el número de colecciones que se pueden configurar para una organización, lo que puede hacer que el filtro no funcione'
slug: b2b-organizations-no-limita-el-numero-de-colecciones-que-se-pueden-configurar-para-una-organizacion-lo-que-puede-hacer-que-el-filtro-no-funcione
status: PUBLISHED
