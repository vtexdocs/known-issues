---
title: 'B2B Organizations no limita el número de colecciones que se pueden configurar para una organización, lo que puede provocar que los filtros basados en segmentos no funcionen'
slug: b2b-organizations-no-limita-el-numero-de-colecciones-que-se-pueden-configurar-para-una-organizacion-lo-que-puede-provocar-que-los-filtros-basados-en-segmentos-no-funcionen
status: PUBLISHED
...
- Pasos:
  ...
  - Inspecciona:
    ...
    - `GET /api/segments` y observe que el segmento se devuelve sin facetas, lo que indica que la cookie no las transportó debido a límites de tamaño. En la consola, también puede ver un error de límite de tamaño de Set-Cookie.
