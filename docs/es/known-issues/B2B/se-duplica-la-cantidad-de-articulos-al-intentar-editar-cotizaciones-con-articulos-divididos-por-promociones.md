...
- La cantidad añadida para una de las entradas del artículo dividido se duplicará para la otra entrada (por ejemplo, si se añaden 12 para la entrada de precio normal, la interfaz de usuario replicará 12 para la entrada gratuita).

- Al guardar la cotización y utilizarla, la cantidad total se añadirá al formulario de pedido y la promoción se calculará correctamente (por ejemplo, si se añadieron 12 unidades para cada entrada, se añadirán 24 unidades del artículo al formulario de pedido; luego, se cobrarán 18 unidades completas y se añadirán 6 gratis, según la regla de la promoción "Compra 3 y llévate 1").

## Workaround

No actualice las cantidades de los artículos en las cotizaciones con artículos divididos por promoción; cree nuevas cotizaciones desde el carrito.