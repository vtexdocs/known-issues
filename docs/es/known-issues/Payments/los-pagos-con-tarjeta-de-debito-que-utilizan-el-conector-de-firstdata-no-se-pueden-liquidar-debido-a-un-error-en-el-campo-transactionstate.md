...
Al utilizar el conector Firstdata para procesar pagos con tarjeta de débito, nuestro código está diseñado para que el campo TransactionState esté establecido como «CAPTURED». Sin embargo, hemos detectado un problema por el que el proveedor envía tanto el valor «CAPTURED» como «SETTLED», lo que provoca un error:
