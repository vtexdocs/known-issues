---
title: 'La página «orderPlaced» devuelve un error 404 para los pedidos sin pago (ID de pago nulo)'
slug: la-pagina-orderplaced-devuelve-un-error-404-para-los-pedidos-sin-pago-id-de-pago-nulo
status: PUBLISHED
