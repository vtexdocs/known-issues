...
status: PUBLISHED
createdAt: 2026-03-18T19:52:35.178Z
updatedAt: 2026-03-18T19:52:35.178Z
...
For specification with type "text", whose values aren't predefined, there won't be an actual `fieldValueId`. In this case, the own text should be used, generating the same string in `srcMessage` and `context` fields.