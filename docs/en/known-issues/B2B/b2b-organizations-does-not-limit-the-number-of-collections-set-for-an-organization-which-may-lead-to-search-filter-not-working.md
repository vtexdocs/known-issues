---
title: 'B2B Organizations does not limit the number of collections set for an organization, which may lead to search filter not working'
slug: b2b-organizations-does-not-limit-the-number-of-collections-set-for-an-organization-which-may-lead-to-search-filter-not-working
status: PUBLISHED
