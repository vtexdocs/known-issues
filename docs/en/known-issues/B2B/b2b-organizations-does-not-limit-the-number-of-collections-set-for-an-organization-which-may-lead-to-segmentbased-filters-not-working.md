---
title: 'B2B Organizations does not limit the number of collections set for an organization, which may lead to segment-based filters not working'
slug: b2b-organizations-does-not-limit-the-number-of-collections-set-for-an-organization-which-may-lead-to-segmentbased-filters-not-working
status: PUBLISHED
