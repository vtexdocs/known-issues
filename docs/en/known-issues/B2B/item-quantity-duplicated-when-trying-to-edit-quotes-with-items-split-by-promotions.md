---
title: 'Item quantity duplicated when trying to edit quotes with items split by promotions'
slug: item-quantity-duplicated-when-trying-to-edit-quotes-with-items-split-by-promotions
status: PUBLISHED
