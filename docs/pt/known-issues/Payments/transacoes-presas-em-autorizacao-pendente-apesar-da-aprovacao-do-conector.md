---
title: 'Transações presas em "Autorização Pendente" apesar da aprovação do conector.'
slug: transacoes-presas-em-autorizacao-pendente-apesar-da-aprovacao-do-conector
status: PUBLISHED
