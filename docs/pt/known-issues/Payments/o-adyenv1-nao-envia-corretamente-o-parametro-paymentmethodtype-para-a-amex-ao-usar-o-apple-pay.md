...
Embora o Apple Pay permita que o usuário faça um pedido usando um cartão Amex, nosso conector legado AdyenV1 não oferece suporte a essa marca.

Nos registros de interação, observa-se que o campo `paymentMethod.type` está preenchido com “scheme”, o que resulta em um erro da Adyen.
