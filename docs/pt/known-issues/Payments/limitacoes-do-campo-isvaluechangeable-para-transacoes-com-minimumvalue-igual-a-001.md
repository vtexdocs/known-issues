---
title: 'Limitações do campo `isValueChangeable` para transações com `minimumValue` igual a 0,01'
slug: limitacoes-do-campo-isvaluechangeable-para-transacoes-com-minimumvalue-igual-a-001
status: PUBLISHED
