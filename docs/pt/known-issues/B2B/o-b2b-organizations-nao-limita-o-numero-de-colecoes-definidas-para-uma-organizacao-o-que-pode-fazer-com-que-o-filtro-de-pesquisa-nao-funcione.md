---
title: 'O B2B Organizations não limita o número de coleções definidas para uma organização, o que pode fazer com que o filtro de pesquisa não funcione'
slug: o-b2b-organizations-nao-limita-o-numero-de-colecoes-definidas-para-uma-organizacao-o-que-pode-fazer-com-que-o-filtro-de-pesquisa-nao-funcione
status: PUBLISHED
...
- Etapas:
  ...
  - Inspecione:
    - `GET /api/sessions?items=*` e confirme se `public.facets` e `search.facets` contêm os `productClusterIds` da coleção.
