...
Isso faz com que a página `orderPlaced` não consiga ser renderizada, retornando um 404 ao cliente.
...
Qualquer pedido com valor total de $0, em que nenhum pagamento real é necessário, por exemplo, um pedido composto inteiramente por produtos com 100% de desconto ou itens gratuitos.
