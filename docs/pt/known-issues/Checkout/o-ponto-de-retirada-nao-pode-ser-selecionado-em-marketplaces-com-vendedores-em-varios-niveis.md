---
title: 'O ponto de retirada não pode ser selecionado em marketplaces com vendedores em vários níveis'
slug: o-ponto-de-retirada-nao-pode-ser-selecionado-em-marketplaces-com-vendedores-em-varios-niveis
status: PUBLISHED
...
Em um marketplace com uma relação multinível (MOI), quando um ponto de retirada é selecionado, o marketplace retorna um erro de comunicação com o vendedor, impedindo o uso de pontos de retirada no marketplace por parte desses vendedores.
...
- Acesse uma conta do marketplace que tenha vendedores regulares usando a relação multinível (MOI)
