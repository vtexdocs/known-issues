---
title: 'A página `orderPlaced` retorna um erro 404 para pedidos sem pagamento (ID de pagamento nulo)'
slug: a-pagina-orderplaced-retorna-um-erro-404-para-pedidos-sem-pagamento-id-de-pagamento-nulo
status: PUBLISHED
...
tag: Checkout
slugEN: orderplaced-page-returns-404-for-orders-with-no-payment-null-payment-id
locale: pt
kiStatus: Backlog
