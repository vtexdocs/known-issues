---
title: 'Centauro O arquivo de mapeamento tem um limite de tamanho de 1 MB para uploads via API.'
slug: centauro-o-arquivo-de-mapeamento-tem-um-limite-de-tamanho-de-1-mb-para-uploads-via-api
status: PUBLISHED
