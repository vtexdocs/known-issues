---
title: 'A permissão "Acesso total ao inventário de logística" não funcionou como esperado'
slug: a-permissao-acesso-total-ao-inventario-de-logistica-nao-funcionou-como-esperado
status: PUBLISHED
createdAt: 2021-12-06T20:59:22.000Z
updatedAt: 2022-06-02T20:23:32.000Z
...
1. Você pode adicionar a permissão "**Acesso total ao estoque de logística**" a um usuário e tentar editar algumas informações no administrador de estoque. Você verá que não será possível fazer nenhuma alteração ou simplesmente visualizar a lista de estoque.
