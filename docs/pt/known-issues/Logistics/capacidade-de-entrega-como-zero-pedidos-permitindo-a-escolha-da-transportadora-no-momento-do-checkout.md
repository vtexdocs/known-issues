---
title: 'Capacidade de entrega como (zero) pedidos, permitindo a escolha da transportadora no momento do checkout'
slug: capacidade-de-entrega-como-zero-pedidos-permitindo-a-escolha-da-transportadora-no-momento-do-checkout
status: PUBLISHED
...
Existe uma possível configuração relacionada à capacidade de entrega usando (pedidos ou SKUs).
...
O checkout permite criar Pedidos agendados para essa janela, durante a janela criada como (zero pedidos)
